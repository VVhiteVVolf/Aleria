...
window.HAEUSER_DATA = {
  "meta": {
    "id": "haus-ysgrif",
    "title": "Haus Ysgrif – Aleria",
    "type": "Bürgerliches Haus",
    "status": "Active",
    "template": "kleinehaeuser",
    "storage": {
      "document": "haus-ysgrif"
    }
  },
  "name": "Haus Ysgrif",
  "hierarchy": [
  ...
  "showMotto": false,
  "sections": {
    "overview": "Haus Ysgrif ist eine bürgerliche Familie aus Gwynthor. Weitere Inhalte folgen.",
    "history": "Folgt …",
    "traditions": "Folgt …",
    "knighthood": "Folgt …",
    "succession": "Folgt …",
  ...
  "images": {
    "haus-wappen": {
      "src": "../Stammbäume/assets/images/houses/Llamreis Ankunft/Bürgerliche/Gwynthor/Ysgrif.png",
      "alt": "Wappen von Haus Ysgrif",
      "format": "square"
    },
    "haus-hauptbild": {
      "src": "",
      "alt": "Ritter von Haus Ysgrif",
      "format": "portrait",
      "maxHeight": 580,
  ...
  "familyTreeEmbed": {
    "src": "../Stammb%C3%A4ume/Stammbaum.html?family=haus-ysgrif&mode=view",
    "title": "Stammbaum von Haus Ysgrif"
  },
  "trivia": [
    "Folgt …"
  ]
