...
export const HOUSE_CONTENT = {
  ...
  "biographySummary": {
    "overview": "Volksnahe Schreiber- und Journalistenfamilie aus Gwynthor, die Celtigerns Echo herausgibt, Schreibende ausbildet und mit kleinen Redaktionsstuben in den größeren Orten Celtigerns Wacht vertreten ist.",
    "history": "Folgt …",
    "character": "Folgt …"
  },
  "placeholders": {
  ...
  "images": {
    "crest": "../Stammbäume/assets/images/houses/Llamreis Ankunft/Bürgerliche/Gwynthor/Falchdyn.png",
    "scene": "../Stammbäume/assets/images/houses/Llamreis Ankunft/Bürgerliche/Gwynthor/Falchdyn-Hausbild.png",
    "banner": "Estryll/Cenyr/Celtigerns_Wacht/Haus_Draig/assets/gwynthor.png",
    "sceneAlt": "Hausbild der Falchdyn"
  },
  "cadets": [],
  "founder": null,
  "heads": [],
