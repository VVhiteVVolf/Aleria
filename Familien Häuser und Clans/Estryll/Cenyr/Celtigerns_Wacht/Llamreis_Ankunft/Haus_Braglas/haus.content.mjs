...
export const HOUSE_CONTENT = {
  ...
  "biographySummary": {
    "overview": "Haus Braglas ist eine bürgerliche Familie aus Gwynthor.",
    "history": "Folgt …",
    "character": "Folgt …"
  },
  "placeholders": {
  ...
  "images": {
    "crest": "../Stammbäume/assets/images/houses/Llamreis Ankunft/Bürgerliche/Gwynthor/Braglas.png",
    "scene": "",
