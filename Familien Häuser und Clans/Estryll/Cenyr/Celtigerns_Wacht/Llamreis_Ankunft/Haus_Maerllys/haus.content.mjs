...
export const HOUSE_CONTENT = {
  ...
  "prepared": true,
  "registerPage": true,
  "biographySourceRevision": 5,
  "biographyIntroTitle": "Über das Haus",
  "biographyHistoryTitle": "Geschichte",
  "biographySummary": {
    "overview": "Haus Maerllys ist eine bürgerliche Familie aus Gwynthor.",
    "history": "Folgt …",
    "character": "Folgt …"
  },
  "placeholders": {
  ...
  "sections": {
    "overview": "Haus Maerllys ist eine bürgerliche Familie aus Gwynthor. Weitere Inhalte folgen.",
    "history": "Folgt …",
    "traditions": "Folgt …",
    "knighthood": "Folgt …",
    "succession": "Folgt …",
  ...
  "images": {
    "crest": "../Stammbäume/assets/images/houses/Llamreis Ankunft/Bürgerliche/Gwynthor/Maerllys.png",
    "scene": "",
