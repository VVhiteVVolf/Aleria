...
export const HOUSE_CONTENT = {
  ...
  "prepared": true,
  "registerPage": true,
  "biographySourceRevision": 11,
  "biographyIntroTitle": "Über das Haus",
  "biographyHistoryTitle": "Geschichte",
  "biographySummary": {
    "overview": "Haus Swyll ist eine weit verzweigte bürgerliche Familie aus Gwynthor.",
    "history": "Folgt …",
    "character": "Folgt …"
  },
  "placeholders": {
  ...
  "sections": {
    "overview": "Haus Swyll ist eine weit verzweigte bürgerliche Familie aus Gwynthor. Weitere Inhalte folgen.",
    "history": "Folgt …",
    "traditions": "Folgt …",
    "knighthood": "Folgt …",
    "succession": "Folgt …",
  ...
  "images": {
    "crest": "../Stammbäume/assets/images/houses/Llamreis Ankunft/Bürgerliche/Gwynthor/Swyll.png",
    "scene": "",
