...
export const HOUSE_CONTENT = {
  ...
  "prepared": true,
  "registerPage": true,
  "biographySourceRevision": 9,
  "biographyIntroTitle": "Über das Haus",
  "biographyHistoryTitle": "Geschichte",
  "biographySummary": {
    "overview": "Ein kleines bürgerliches Geschlecht aus Gwynthor, dessen Angehörige seit Generationen als Diener und Bedienstete im Haushalt des Hauses Draig stehen.",
    "history": "Folgt …",
    "character": "Folgt …"
  },
  "placeholders": {
  ...
  "sections": {
    "overview": "Ein kleines bürgerliches Geschlecht aus Gwynthor, dessen Angehörige seit Generationen als Diener und Bedienstete im Haushalt des Hauses Draig stehen. Weitere Inhalte folgen.",
    "history": "Folgt …",
    "traditions": "Folgt …",
    "knighthood": "Folgt …",
    "succession": "Folgt …",
  ...
  "images": {
    "crest": "../Stammbäume/assets/images/houses/Llamreis Ankunft/Bürgerliche/Gwynthor/Draenmelyn.png",
    "scene": "",
