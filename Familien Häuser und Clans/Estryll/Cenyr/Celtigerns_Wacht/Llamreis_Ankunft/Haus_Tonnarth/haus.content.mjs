...
export const HOUSE_CONTENT = {
  ...
  "biographySummary": {
    "overview": "Haus Tonnarth ist eine bürgerliche Familie aus Gwynthor.",
    "history": "Folgt …",
    "character": "Folgt …"
  },
  "placeholders": {
  ...
  "sections": {
    "overview": "Haus Tonnarth ist eine bürgerliche Familie aus Gwynthor. Weitere Inhalte folgen.",
    "history": "Folgt …",
    "traditions": "Folgt …",
    "knighthood": "Folgt …",
    "succession": "Folgt …",
  ...
  "images": {
    "crest": "../Stammbäume/assets/images/houses/Llamreis Ankunft/Bürgerliche/Gwynthor/Tonnarth.png",
    "scene": "",
