...
window.HAEUSER_DATA = {
  "meta": {
    "id": "haus-tonnarth",
    "title": "Haus Tonnarth – Aleria",
    "type": "Bürgerliches Haus",
    "status": "Active",
    "template": "kleinehaeuser",
    "storage": {
      "document": "haus-tonnarth"
    }
  },
  "name": "Haus Tonnarth",
  "hierarchy": [
  ...
  "images": {
    "haus-wappen": {
      "src": "../Stammbäume/assets/images/houses/Llamreis Ankunft/Bürgerliche/Gwynthor/Tonnarth.png",
      "alt": "Wappen von Haus Tonnarth",
      "format": "square"
    },
    "haus-hauptbild": {
      "src": "",
      "alt": "Ritter von Haus Tonnarth",
      "format": "portrait",
      "maxHeight": 580,
  ...
  "familyTreeEmbed": {
    "src": "../Stammb%C3%A4ume/Stammbaum.html?family=haus-tonnarth&mode=view",
    "title": "Stammbaum von Haus Tonnarth"
  },
  "trivia": [
    "Folgt …"
  ]
