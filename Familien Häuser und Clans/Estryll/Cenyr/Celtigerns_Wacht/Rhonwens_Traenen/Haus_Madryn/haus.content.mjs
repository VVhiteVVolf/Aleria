...
export const HOUSE_CONTENT = {
  ...
  "biographySummary": {
    "overview": "Haus Madryn ist in Rhonwens Tränen in Celtigerns Wacht verzeichnet.",
    "history": "Folgt …",
    "character": "Folgt …"
  },
  "placeholders": {
  ...
  "images": {
    "crest": "../Stammbäume/assets/images/houses/Rhonwens Tränen/Ritterliche/Madryn.png",
    "scene": "Estryll/Cenyr/Celtigerns_Wacht/Rhonwens_Traenen/Haus_Madryn/assets/krieger.png",
    "banner": "Estryll/Cenyr/Celtigerns_Wacht/Rhonwens_Traenen/Haus_Arwydd/assets/herrschaftsbanner.png",
    "sceneAlt": "Krieger von Haus Madryn"
  },
  "cadets": [],
  "founder": null,
  "heads": [],
