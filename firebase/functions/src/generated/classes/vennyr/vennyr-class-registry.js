import { getDerwynClassDefinition } from './derwyn-curriculum.js?v=20260909-dragon-parent-v2';
import { SIRENENTANZ_FORM_IDS as F, SIRENENTANZ_EXPERT_PATH_IDS } from '../../combat-styles/sirenentanz/sirenentanz-forms.js?v=20260909-dragon-parent-v2';
import { ARMOR_ROUTINE } from '../armor-routine.js';

export { VENNYR_CLASS_IDS } from './vennyr-class-ids.js?v=20260909-class-forms-v1';
...
const configs = [
  ...
  { classId: 'morwyr', name: 'Morwyr', focus: 'Partisane, Enteraxt und Harpune', trainingFocus: 'Ritter des Decks und der Brandung',
    ...
    features: [feature('morwyr-seebeine', 'Seebeine', 1, '+2 auf Balanceproben an Deck; der Situationsbonus wird manuell berücksichtigt und ist kein allgemeiner RK-Bonus.'),
      feature('morwyr-entergriff', 'Sicherer Entergriff', 6, '+1 auf den Angriffswurf mit Wyrmtanz-Harpunentechniken; keine zusätzliche Attacke.'),
      ...
      feature('morwyr-deckmeister', 'Meister des Decks', 20, 'Einmal pro Beitrag +1 Schaden auf einen Partisanen- oder Enteraxttreffer nach einem eigenen gelungenen Wyrmtanz-Verschiebemanöver.')],
  ...
  { classId: 'rhyfelwyr', name: 'Rhyfelwyr', focus: 'Schwere Hiebwaffen und Linienbruch', trainingFocus: 'Wucht und Standfestigkeit',
    ...
    features: [feature('rhyfelwyr-stand', 'Stand gegen den Sturm', 1, '+1 auf Rettungswürfe gegen Furcht und Umwerfen; nur bei einem tatsächlich geforderten passenden Wurf.'),
      feature('rhyfelwyr-wucht', 'Kontrollierte Wucht', 6, 'Bei Wyrmtanz-Angriffen mit schwerer Axt, Hammer, Flegel oder Kolben: −1 Angriff und +1 Schaden. Kein Bonus auf Schwertangriffe.'),
  ...
  { classId: 'ceidwyn', name: 'Ceidwyn', templateId: 'ceidwynr', focus: 'Kurzbogen, Armbrust, Säbel und Dreizack', trainingFocus: 'Schütze und Nahkämpfer der Flotte',
    ...
    features: [feature('ceidwyn-seeblick', 'Seeblick', 1, '+1 Angriff mit Kurzbogen oder Armbrust. Der Bonus gilt einmal und nicht für Säbel oder Dreizack.'),
      ...
      feature('ceidwyn-wechsel', 'Meister beider Distanzen', 20, 'Nach einem bezahlten Wechsel zwischen Fern- und Nahwaffe erhält der erste passende Wyrmtanz-Angriff im selben Beitrag +1 Angriff. Waffenwechsel bleibt kostenpflichtig.')],
  ...
  { classId: 'rhiddwyr', name: 'Rhiddwyr', templateId: 'rhiddwyrr', focus: 'Reiterwaffen, Armbrust und beweglicher Nahkampf', trainingFocus: 'Fahrender Ritter der Höhen und Küsten',
    ...
    features: [feature('rhiddwyr-trittsicher', 'Trittsicherer Reisender', 1, '+2 auf manuell ausgewertete Reitproben in Hügeln und Küstenpfaden; keine zusätzlichen Aktionen des Rosses.'),
      feature('rhiddwyr-sattel', 'Sicher im Sattel', 6, '+1 Angriff bei ausdrücklich berittenen Wyrmtanz-Techniken. Zu Fuß entfällt dieser Bonus.'),
...
const definitions = [...configs.map(definition), getDerwynClassDefinition()];
