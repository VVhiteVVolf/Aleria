...
const forms = [
  ...
  { id: F.advanced, shortName: 'Schritt des Huskarls', number: 'II', kind: 'advanced', minimumLevel: 7, maximumTrainingLevel: 8,
    description: 'Verbindende Lektionen und alternative Manöver für die Haupt- und Nebenwaffen der Klasse.' },
  ...
  { id: F.militia, shortName: 'Hirdwacht', kind: 'path', minimumLevel: 6, maximumTrainingLevel: 20,
