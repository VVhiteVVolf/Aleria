...
export const BRUELLENDER_TECHNIQUES = Object.freeze([
  ...
  make({ slug: 'hallender-rundschlag', name: 'Hallender Rundschlag', minimumLevel: 12, costs: ['action', 'bonus-action', 'reaction'], maximumTargets: 3, target: 'Bis zu drei Gegner',
  ...
  make({ slug: 'erdbebenpranke', name: 'Erdbebenpranke', minimumLevel: 16, costs: ['action', 'bonus-action', 'reaction', 'special-action'], maximumTargets: 4, target: 'Bis zu vier Gegner',
