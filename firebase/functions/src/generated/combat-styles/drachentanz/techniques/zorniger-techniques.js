...
export const ZORNIGER_TECHNIQUES = Object.freeze([
  ...
  make({ slug: 'rasende-folge', name: 'Rasende Folge', minimumLevel: 12, costs: ['action', 'special-action'], maximumTargets: 2, target: 'Bis zu zwei Gegner',
  ...
  make({ slug: 'sturm-ohne-richtung', name: 'Sturm ohne Richtung', minimumLevel: 16, costs: ['bonus-action', 'special-action'], maximumTargets: 3, target: 'Bis zu drei Gegner',
