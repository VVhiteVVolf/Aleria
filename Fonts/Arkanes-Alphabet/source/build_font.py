...
fb.setupGlyf(glyphs);fb.setupHorizontalMetrics(metrics);fb.setupHorizontalHeader(ascent=860,descent=-140,lineGap=100)
fb.setupNameTable({'familyName':'Aleria Arcana','styleName':'Regular','uniqueFontIdentifier':'AleriaArcana-Regular-Ritual-2.000','fullName':'Aleria Arcana Regular','psName':'AleriaArcana-Regular','version':'Version 2.000','description':'Alte Ritualrunen. 33 canonical signs.','licenseDescription':'Glyph artwork created for Aleria. Use, modification and web embedding permitted.'})
fb.setupOS2(sTypoAscender=860,sTypoDescender=-140,sTypoLineGap=100,usWinAscent=860,usWinDescent=140,fsType=0,sxHeight=740,sCapHeight=740)
fb.setupPost();fb.setupMaxp()
addOpenTypeFeaturesFromString(fb.font,(SOURCE/'ligatures.fea').read_text(encoding='utf-8'))
...
print('Built Aleria Arcana 2.0: TTF, WOFF and WOFF2.')
