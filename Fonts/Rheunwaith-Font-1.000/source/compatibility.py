"""Latin text extensions using the Gezeitenrunen master outlines.
...
def extend(glyphs,metrics,cmap,records):
    ...
    # All Rheunwaith base letters plus Q and sharp S are already present.
    ...
    compose_rules={(base('U'),marks[0x308]):base('Ü')}
    lower_aliases={}
    def accented(cp):
    ...
    charmap('Ŋŋ','rune26');charmap('Þþ','rune18')
    ...
    svg('exclamation','M90 735 L180 735 L171 244 L99 244 Z M135 129 C197 129 197 37 135 37 C73 37 73 129 135 129 Z',280)
    ...
    comp('copyright',[('editorialRing',ident),('rune02',(.43,0,0,.43,380-metrics['rune02'][0]*.215,224))],760);charmap('©','copyright')
