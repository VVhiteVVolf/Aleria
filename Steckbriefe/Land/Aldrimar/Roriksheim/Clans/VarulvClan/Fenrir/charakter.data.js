window.STECKBRIEF_DATA = {
  meta: {
    id: "aldrimar-roriksheim-varulv-fenrir",
    titel: "Fenrir Varulv - Aldrimar",
  ...
  hierarchie: [
    ...
    { typ: "Clan", name: "Varulv Clan", slug: "varulv-clan" },
    { typ: "Charakter", name: "Fenrir Varulv", slug: "fenrir-varulv" }
  ],
