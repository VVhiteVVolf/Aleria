window.STECKBRIEF_DATA = {
  meta: {
    id: "cenyr-celtigernswacht-adelshaeuser-hausdraig-gawain-draig",
    titel: "Gawain Draig - Aleria",
    kategorie: "Charaktersteckbrief",
    status: "Testcharakter",
    editorVersion: 2
  },
  ...
  wappen: {
    src: "https://i.imgur.com/Ok6Zdpl.png",
    alt: "Wappen von Haus Draig",
    scale: 1,
    format: "square",
    fit: "contain"
  },
  ...
  hierarchie: [
    ...
    { typ: "Grafschaft", name: "Celtigerns Wacht", slug: "celtigerns-wacht" },
    { typ: "Ebene", name: "Adelshäuser", slug: "adelshaeuser" },
    { typ: "Haus", name: "Haus Draig", slug: "haus-draig" },
    { typ: "Charakter", name: "Gawain Draig", slug: "gawain-draig" }
  ],
  ...
  fakten: [
    {
      ...
      eintraege: [
        ...
        ["Sternzeichen", "-"],
        ["Größe", "-"],
        ["Herkunft", "Cenyr, Celtigerns Wacht"]
      ]
    },
    {
        ...
        eintraege: [
          {
            ...
            profil: {
              ...
              bildFormat: "portrait",
              bildFit: "contain",
              kurztext: "Kurzbeschreibung des Hauses, seiner Rolle und seiner Bedeutung fuer die Figur.",
