(function(){
  const actions = {
    ...
    'zettel-rich-format': el => window.zettelRichFormat(el.dataset.richTarget, el.dataset.richFormat, el.dataset.richValue || ''),
  ...
  const inputActions = {
    ...
    'zettel-rich-field': el => window.zettelRichField(el.dataset.field, el.innerHTML),
    ...
    'zettel-article-rich-field': el => window.zettelArtikelRich(Number(el.dataset.articleIndex), el.dataset.field, el.innerHTML),
    ...
    'person-rich-field': el => window.sbPersonRichField(Number(el.dataset.personIndex), el.dataset.field, el.innerHTML),
