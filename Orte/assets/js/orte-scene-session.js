...
(function () {
  ...
  const stylePaths = [
    ...
    { href: "styles/comments.css?v=orte-language-bubbles-v1" },
    { href: "styles/comment-bubbles.css?v=orte-language-bubbles-v2" },
    ...
    { href: "styles/module-page-bounty.css?v=orte-bounty-traits-v1" },
    ...
    { href: "styles/module-page-family-tree.css?v=orte-family-tree-registry-v1" },
    ...
    { href: "styles/module-page-language.css?v=orte-language-template-v3" },
    { href: "styles/module-page-name-list.css?v=orte-argenti-stoicheia-v1" },
    { href: "styles/module-page-script-table.css?v=orte-argenti-stoicheia-v1" },
  ...
  const scriptPaths = [
    ...
    "modules/house-warriors/house-warriors-data.js?v=orte-house-warriors-images-v2",
    "modules/language/language-data.js?v=orte-language-template-v1",
    ...
    "modules/family-tree-embed/family-tree-embed-data.js?v=orte-family-tree-registry-v1",
    "modules/family-tree-embed/family-tree-embed-catalog.js?v=orte-family-tree-registry-v1",
    ...
    "modules/comments/comments-spell-fonts.js?v=orte-language-bubbles-v2",
    "modules/comments/comments-render.js?v=orte-language-bubbles-v1",
    ...
    "modules/comments/comments-segment-base.js?v=orte-language-bubbles-v1",
    "modules/comments/comments-segments.js?v=orte-language-bubbles-v1",
    ...
    "modules/comments/comments-draft.js?v=orte-language-bubbles-v1",
    ...
    "modules/comments/comments-edit-segments.js?v=orte-language-bubbles-v1",
    "modules/comments/comments-edit-preview.js?v=orte-almanach-session-v1",
    "modules/comments/comments-edit.js?v=orte-language-bubbles-v1",
    ...
    "modules/comments/comments-segment-events.js?v=orte-language-bubbles-v1",
    ...
    "modules/comments/comments-reader-events.js?v=orte-language-bubbles-v1",
    ...
    "modules/module-editor/module-editor-bounty.js?v=orte-bounty-traits-v1",
    "modules/module-editor/module-editor-map-template.js?v=orte-module-templates-v2",
    "modules/language/language-module-editor.js?v=orte-language-template-v1",
    "modules/name-list/name-list-module-editor.js?v=orte-name-list-v2",
    "modules/script-table/script-table-module-editor.js?v=orte-script-table-v1",
    ...
    "modules/family-tree-embed/family-tree-embed-editor.js?v=orte-family-tree-registry-v1",
    ...
    "modules/module-editor/module-editor-workflow.js?v=orte-name-list-v1",
    ...
    "modules/bounty/bounty-renderer.js?v=orte-bounty-traits-v1",
    ...
    "modules/language/language-renderer.js?v=orte-language-template-v1",
    "modules/name-list/name-list-renderer.js?v=orte-name-list-v2",
    "modules/script-table/script-table-renderer.js?v=orte-script-table-v1",
    ...
    "vendor/d3/7.9.0/d3.min.js?v=orte-family-chart-v1",
    ...
    "modules/family-tree-embed/family-tree-embed-renderer.js?v=orte-family-tree-registry-v1",
    ...
    "modules/inline-editor/inline-editor-bounty.js?v=orte-bounty-traits-v1",
    "modules/inline-editor/inline-module-editor.js?v=orte-script-table-v1",
    ...
    "modules/language/language-inline-editor.js?v=orte-language-template-v1",
    "modules/name-list/name-list-inline-editor.js?v=orte-name-list-v2",
    "modules/script-table/script-table-inline-editor.js?v=orte-script-table-v1",
    ...
    "modules/inline-editor/inline-editor-events.js?v=orte-family-migration-v1",
    "modules/module-editor/module-editor-events.js?v=orte-family-migration-v1",
