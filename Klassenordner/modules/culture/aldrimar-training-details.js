...
function skaldDetails(plan) {
  ...
  return `<section class="aldrimar-special-training" aria-labelledby="skald-title"><p class="eyebrow">Kampfbarde · Grundrepertoire 1–5</p><h3 id="skald-title">Freyas Aufbau als Ausgangspunkt</h3>
    ...
    <p>Freyas magischer Referenzstand ist auf <strong>Stufe 5</strong> belegt. Die vorgeschlagene Verteilung auf Stufe 1–4 ordnet dieses vorhandene Repertoire. Zusätzlich stehen nichtmagische Stimm- und Waffenmanöver bis Stufe 20 zur Auswahl. Sie verbrauchen die angezeigten Aktionsressourcen; magische Lieder werden gesondert erlernt.</p>
