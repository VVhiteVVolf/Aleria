...
export const HOUSE_CHIFFYDDLON_FAMILY = Object.freeze({
  ...
  persons: [
    ...
    awayWoman('mererid-1657-chiffyddlon', 'Mererid Chiffyddlon', '1657', '????', 'Haus Eryr'),
    ...
    spouse('sheev-eryr', 'Sheev Eryr', 'male', '1657', '', 'house-eryr'),
  ...
  partnerships: [
    ...
    createMarriage('marriage-mererid-sheev-chiffyddlon', ...COUPLES.mererid),
