...
export const HOUSE_ARTH_FAMILY = Object.freeze({
  ...
  cadetBranches: [
    createCadetHouseBranch({ id: 'cadet-pawen-lamorak', name: 'Haus Pawen', parentPartnershipId: 'marriage-lamorak-mared', houseId: 'house-pawen', targetFamilyId: 'haus-pawen', notes: 'Lamorak Arth und Mared begründen Haus Pawen; der Knoten hängt direkt unter ihrem Paar.' }),
    createCadetHouseBranch({ id: 'cadet-crafanc-artgal', name: 'Haus Crafanc', parentPartnershipId: 'marriage-artgal-amdarch', houseId: 'house-crafanc', targetFamilyId: 'haus-crafanc', notes: 'Artgal Arth und Amdarch begründen Haus Crafanc; der Knoten hängt direkt unter ihrem Paar.' }),
    createCadetHouseBranch({ id: 'cadet-cwningod-galeshin', name: 'Haus Cwningod', parentPartnershipId: 'marriage-galeshin-arianhrod', houseId: 'house-cwningod', targetFamilyId: 'haus-cwningod', notes: 'Galeshin Arth und Arianhrod begründen Haus Cwningod; der Knoten hängt direkt unter ihrem Paar.' }),
    createCadetHouseBranch({ id: 'cadet-unigol-trahaern', name: 'Haus Unigol', parentPartnershipId: 'marriage-trahaern-ceridwen', houseId: 'house-unigol', targetFamilyId: 'haus-unigol', notes: 'Trahaern Arth und Ceridwen Pawen begründen Haus Unigol; der Knoten hängt direkt unter ihrem Paar.' }),
    createCadetHouseBranch({ id: 'cadet-morthwyll-heddwen', name: 'Haus Morthwyll', parentPartnershipId: 'marriage-heddwen-sayres', houseId: 'house-morthwyll', targetFamilyId: 'haus-morthwyll', notes: 'Heddwen Arth und Sayres Morthwyll begründen diese fortgeführte Hauslinie direkt unter ihrem Paar.' }),
    createCadetHouseBranch({ id: 'cadet-eirth-rhynnon', name: 'Haus Eirth', parentPartnershipId: 'marriage-rhynnon-kyndra', houseId: 'house-eirth', targetFamilyId: 'haus-eirth', notes: 'Rhynnon Arth und Kyndra Crafanc begründen Haus Eirth; der Knoten hängt direkt unter ihrem Paar.' }),
    createCadetHouseBranch({ id: 'cadet-selwyn-tegwen', name: 'Haus Selwyn', parentPartnershipId: 'marriage-tegwen-morgan', houseId: 'house-selwyn', targetFamilyId: 'haus-selwyn', notes: 'Tegwen Arth und Morgan Selwyn begründen diese fortgeführte Hauslinie direkt unter ihrem Paar.' }),
    ...
    marriedAway('married-away-pawen-isobel', 'Haus Pawen', 'marriage-isobel-sadwrn', 'house-pawen'),
    marriedAway('married-away-crafanc-wenonah', 'Haus Crafanc', 'marriage-wenonah-cynwrig', 'house-crafanc'),
    marriedAway('married-away-dianc-ffraid', 'Haus Dianc', 'marriage-ffraid-gareth', 'house-dianc'),
    marriedAway('married-away-cwningod-rian', 'Haus Cwningod', 'marriage-rian-sath', 'house-cwningod'),
    marriedAway('married-away-pawen-tarian', 'Haus Pawen', 'marriage-tarian-brac', 'house-pawen'),
    marriedAway('married-away-crafanc-afanen1660', 'Haus Crafanc', 'marriage-afanen-elisud', 'house-crafanc'),
    ...
    marriedAway('married-away-crafanc-olwen', 'Haus Crafanc', 'marriage-olwen-melwas', 'house-crafanc'),
    marriedAway('married-away-dyngwn-lynfa1696', 'Haus Dyngwn', 'marriage-lynfa-derwyn', 'house-dyngwn'),
    marriedAway('married-away-cwningod-tiwlip', 'Haus Cwningod', 'marriage-tiwlip-galeshin', 'house-cwningod'),
