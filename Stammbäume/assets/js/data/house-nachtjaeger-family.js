...
export const HOUSE_NACHTJAEGER_FAMILY = Object.freeze({
  ...
  persons: [
    ...
    spouse('stiofan-blar', 'Stiofán Blár', 'male', '1672', '1720', 'house-blar'),
  ...
  cadetBranches: [
    ...
    marriedAway('married-away-inghild-nachtjaeger-blar', 'Clan Blár', 'marriage-inghild-stiofan-nachtjaeger', 'house-blar', 'haus-blar'),
