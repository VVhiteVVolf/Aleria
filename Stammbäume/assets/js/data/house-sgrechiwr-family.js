...
export const HOUSE_SGRECHIWR_FAMILY = Object.freeze({
  ...
  persons: [
    ...
    person('aerona-balchder', 'Aerona Balchder', 'female', '????', '', 'house-balchder', {
      familyRole: 'married',
      portrait: HOUSE_BALCHDER_PORTRAITS['aerona-balchder'] || ''
    }),
