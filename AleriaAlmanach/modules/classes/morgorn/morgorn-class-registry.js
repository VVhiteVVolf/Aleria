...
const BLUEPRINTS = Object.freeze({
  karnach: Object.freeze({
    name: 'Grungar', focus: 'Gebirge, Engstellen und gemeinsamer Linienhalt', trainingFocus: 'Bergkampf und Hallenwehr', affiliation: 'Kriegerkaste der Bergknechte',
  ...
  haldr: Object.freeze({
    name: 'Varor', focus: 'Persönlicher Schutz und gebundene Obhut', trainingFocus: 'Hüterdienst und Schildkampf', affiliation: 'Kriegerkaste der Hüter',
  ...
  zernach: Object.freeze({
    name: 'Thalor', focus: 'Tore, Mauern und standhafte Verteidigung', trainingFocus: 'Festungswacht und schwerer Linienkampf', affiliation: 'Kriegerkaste der Wächter',
  ...
  wairg: Object.freeze({
    name: 'Kuralan', focus: 'Herden, Wildnis und Kampf auf weitem Gelände', trainingFocus: 'Hirtenwacht und Stangenwaffen', affiliation: 'Kriegerkaste der Hirten',
  ...
  dornach: Object.freeze({
    name: 'Toran', focus: 'Grenzpatrouille, Fährten und Gebirgskampf', trainingFocus: 'Grenzdienst und bewegliche Jagd', affiliation: 'Kriegerkaste der Grenzer',
  ...
  skarrach: Object.freeze({
    name: 'Bragan', focus: 'Berittener Durchbruch und schwere Stoßangriffe', trainingFocus: 'Anritt, Sturm und Widderreiterei', affiliation: 'Kriegerkaste der Stürmer',
  ...
  rheach: Object.freeze({
    name: 'Rhean', focus: 'Weihe, Schutz und Dienst an Rhea', trainingFocus: 'Gesalbtes Kriegertum und Klerus', affiliation: 'Religiöse Kriegerkaste Rheas',
  ...
  garnach: Object.freeze({
    name: 'Falgar', focus: 'Luntenschloss, Konstruktion und alchemistische Feldarbeit', trainingFocus: 'Schwarzpulver und technische Waffenführung', affiliation: 'Kriegerkaste der Luntierer',
...
export function getMorgornClassDefinition(id) {
  const aliases = {
    ...Object.fromEntries(Object.entries(BLUEPRINTS).map(([id, entry]) => [entry.name.toLocaleLowerCase('de'), id])),
    bergknecht: 'karnach',
    bergknechte: 'karnach',
    huter: 'haldr',
    wachter: 'zernach',
