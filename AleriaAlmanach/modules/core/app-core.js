...
const MODULE_STORE_SCHEMA_VERSION = 5;
...
const ALMANACH_BACKUP_SCHEMA_VERSION = 3;
...
function sanitizeModulePage(page, fallbackTitle = '') {
  ...
  if (page.familyPage) {
    next.family = sanitizeFamilyData(page.family);
  }

  if (page.familyTreePage) {
    next.familyTree = sanitizeFamilyTreeEmbedData(page.familyTree);
  }
