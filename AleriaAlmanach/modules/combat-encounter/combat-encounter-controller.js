import { deriveCombatEncounterState, getActiveCombatEncounter, normalizeCombatEncounterEvent, buildEncounterExperienceAwards } from '../combat/combat-encounter-model.js?v=20260909-dragon-parent-v2';
import { getEncounterValidationError, prepareEncounterParticipants } from '../combat/combat-encounter-lifecycle.js?v=20260909-dragon-parent-v2';
...
import { collectSceneActorIds, buildEncounterCandidates, readEncounterParticipants, captureEncounterCandidateDraft } from './combat-encounter-candidates.js?v=20260909-dragon-parent-v2';
import { renderActiveEncounterPanel } from './combat-encounter-panel.js?v=20260909-dragon-parent-v2';
import { commitSceneCombatStatus } from '../combat-status/combat-status-controller.js?v=20260909-dragon-parent-v2';
import { ensureCombatEncounterDialog, filterEncounterCandidates, renderCombatEncounterComment, renderEncounterCandidates,
  ...
  setEncounterMode, setEncounterPreview } from './combat-encounter-ui.js?v=20260909-dragon-parent-v2';
