...
export const COMBAT_ACTION_RESOURCE_DEFINITIONS = Object.freeze([
  { id: 'action', name: 'Aktion', current: 1, maximum: 1, scope: 'comment', category: 'action', icon: './public/assets/combat-profile-icons/action.png' },
  { id: 'bonus-action', name: 'Bonusaktion', current: 1, maximum: 1, scope: 'comment', category: 'action', icon: './public/assets/combat-profile-icons/bonus-action.png' },
  { id: 'reaction', name: 'Reaktion', current: 1, maximum: 1, scope: 'comment', category: 'action', icon: './public/assets/combat-profile-icons/reaction.png' },
  ...
  { id: 'aura-focus', name: 'Aura-Fokuspunkt', current: 0, maximum: 0, scope: 'persistent', category: 'aura', recovery: 'day', icon: './public/assets/combat-profile-icons/aura-focus.png' }
]);
...
export function recoverDailyCombatResources(resources = [], recoveryDayKey = '') {
  ...
  return (Array.isArray(resources) ? resources : []).map(resource => {
    ...
    if (!previousDayKey) return { ...resource, recoveryDayKey: dayKey };
