import { DRACHENTANZ_FORM_NAMES } from './drachentanz/drachentanz-ids.js';
import { getSirenentanzForms } from './sirenentanz/sirenentanz-forms.js';
...
const forms = new Map([
  ...
  ...getSirenentanzForms().map(form => [form.id, { styleId: 'sirenentanz', label: `Sirenentanz · ${form.name}` }]),
