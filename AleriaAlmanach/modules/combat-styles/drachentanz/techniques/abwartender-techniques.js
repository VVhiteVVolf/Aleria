...
export const ABWARTENDER_TECHNIQUES = Object.freeze([
  ...
  make({ slug: 'gebrochener-ansturm', name: 'Gebrochener Ansturm', minimumLevel: 12, costs: ['action', 'bonus-action', 'reaction'],
  ...
  make({ slug: 'kreis-der-stillen-schuppen', name: 'Kreis der stillen Schuppen', minimumLevel: 16, costs: ['action', 'bonus-action', 'reaction'], maximumTargets: 2, target: 'Bis zu zwei Gegner',
  ...
  make({ slug: 'unbewegtes-herz', name: 'Unbewegtes Herz', minimumLevel: 18, costs: ['action', 'bonus-action', 'reaction'],
