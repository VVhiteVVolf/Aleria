...
export const FLIEGENDER_TECHNIQUES = Object.freeze([
  ...
  make({ slug: 'doppelschwinge', name: 'Doppelschwinge', minimumLevel: 12, costs: ['bonus-action', 'special-action'], maximumTargets: 2, target: 'Bis zu zwei Gegner',
  ...
  make({ slug: 'tanz-ueber-klingen', name: 'Tanz über Klingen', minimumLevel: 16, costs: ['reaction', 'bonus-action', 'special-action'],
  ...
  make({ slug: 'sturmkranz', name: 'Sturmkranz', minimumLevel: 18, costs: ['action', 'reaction', 'special-action'], maximumTargets: 3, target: 'Bis zu drei Gegner',
