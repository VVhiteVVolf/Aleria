...
export const KREISCHENDER_TECHNIQUES = Object.freeze([
  ...
  bard(F.kreischender, 'barddwyr-kreischender', RAPIER, { slug: 'kreischender-zerbrochener-takt', name: 'Zerbrochener Takt', minimumLevel: 12, slotBands: ['expert'], tier: 'Kreischender Drache', costs: ['action', 'bonus-action', 'reaction'],
  ...
  bard(F.kreischender, 'barddwyr-kreischender', RAPIER, { slug: 'kreischender-tanzende-fermate', name: 'Tanzende Fermate', minimumLevel: 16, slotBands: ['expert'], tier: 'Kreischender Drache', costs: ['action', 'bonus-action', 'reaction'],
