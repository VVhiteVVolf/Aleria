...
export const UCHELWYR_MOUNTED_TECHNIQUES = Object.freeze([
  ...
  mounted(F.abwartender, { slug: 'unbewegter-reiter', name: 'Unbewegter Reiter', minimumLevel: 15, slotBands: ['expert'], costs: ['action', 'bonus-action', 'reaction'], activationType: 'reaction',
  ...
  mounted(F.fliegender, { slug: 'galoppierende-drachenspur', name: 'Galoppierende Drachenspur', minimumLevel: 15, slotBands: ['expert'], costs: ['action', 'bonus-action', 'reaction'],
