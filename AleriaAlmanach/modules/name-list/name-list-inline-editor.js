  ...
  return `
    <div class="inline-edit-section">
      ...
      <div class="inline-edit-grid">
        ...
        <div class="inline-edit-field"><span class="inline-edit-label">Verzierungsstil</span><select class="inline-edit-select" data-name-list-inline-field="ornamentStyle">${buildNameListStyleOptions(data.ornamentStyle)}</select></div>
