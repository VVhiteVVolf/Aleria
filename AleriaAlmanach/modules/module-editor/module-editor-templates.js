...
const MODULE_TEMPLATE_REGISTRY = {
  ...
  language: {
    id: 'language',
    pageType: 'language',
    pageFlag: 'languagePage',
    label: 'Sprachen-Template',
    pageLabel: 'Sprachen-Template',
    defaultTitle: 'Neue Sprache',
    defaultSubtitle: 'Alphabet, Schrift und Sprachkunde',
    entryType: 'Sprache',
    typeMatchers: ['sprache', 'sprachen', 'alphabet', 'schrift', 'runenschrift', 'sprachkunde'],
    createPages: () => [createDefaultLanguagePage(0)],
    createPage: index => createDefaultLanguagePage(index),
    buildEditorFields: page => buildLanguageModuleEditorFields(page),
    collectEditorPage: (card, page) => collectLanguageModuleEditorPage(card, page),
    renderPage: (page, entry, pageIndex, total) => buildLanguagePage(page, entry, pageIndex, total),
    renderInlinePage: (page, entry, pageIndex, total) => buildInlineComplexTemplatePage(page, entry, pageIndex, total, 'language')
  },
  'name-list': {
    id: 'name-list',
    pageType: 'name-list',
    pageFlag: 'nameListPage',
    label: 'Namenslisten-Template',
    pageLabel: 'Namenslisten-Template',
    defaultTitle: 'Neue Namensliste',
    defaultSubtitle: 'Namensvorschläge nach Gruppen',
    entryType: 'Namensliste',
    typeMatchers: ['namensliste', 'namen', 'vornamen', 'namensarchiv'],
    createPages: () => [createDefaultNameListPage(0)],
    createPage: index => createDefaultNameListPage(index),
    buildEditorFields: page => buildNameListModuleEditorFields(page),
    collectEditorPage: (card, page) => collectNameListModuleEditorPage(card, page),
    renderPage: (page, entry, pageIndex, total) => buildNameListPage(page, entry, pageIndex, total),
    renderInlinePage: (page, entry, pageIndex, total) => buildInlineComplexTemplatePage(page, entry, pageIndex, total, 'name-list')
  },
  'script-table': {
    id: 'script-table',
    pageType: 'script-table',
    pageFlag: 'scriptTablePage',
    label: 'Schriftzeichen-Tabelle',
    pageLabel: 'Schriftzeichen-Tabelle',
    defaultTitle: 'Neue Zeichentabelle',
    defaultSubtitle: 'Alphabet, Lautwerte und Bedeutungen',
    entryType: 'Zeichentabelle',
    typeMatchers: ['zeichentabelle', 'alphabettabelle', 'runentabelle', 'schriftzeichen'],
    createPages: () => [createDefaultScriptTablePage(0)],
    createPage: index => createDefaultScriptTablePage(index),
    buildEditorFields: page => buildScriptTableModuleEditorFields(page),
    collectEditorPage: (card, page) => collectScriptTableModuleEditorPage(card, page),
    renderPage: (page, entry, pageIndex, total) => buildScriptTablePage(page, entry, pageIndex, total),
    renderInlinePage: (page, entry, pageIndex, total) => buildInlineComplexTemplatePage(page, entry, pageIndex, total, 'script-table')
  },
  landing: {
    id: 'landing',
    pageType: 'landing',
