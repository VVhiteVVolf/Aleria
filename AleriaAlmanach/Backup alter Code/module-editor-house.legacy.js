...
// Dies ist der komplette Stand von modules/module-editor/module-editor-house.js, BEVOR am
...
function buildHouseModuleEditorFieldsLegacy(page) {
...
function collectHouseModuleEditorPageLegacy(card, page) {
  page.housePage = true;
