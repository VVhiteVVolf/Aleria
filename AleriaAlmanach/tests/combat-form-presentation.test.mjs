...
test('alle 503 Katalogtechniken verwenden stabile Formschlüssel und dieselben Namen unabhängig von gespeicherten Alttexten', () => {
  ...
  assert.equal(entries.length, 503);
  assert.equal(labels.size, 21);
