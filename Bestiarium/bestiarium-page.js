import { BESTIARY_ENTRIES } from './modules/catalog/catalog-data.js?v=20260910-nautiloiden-cuimhorn-v1';
import { BESTIARY_TOPICS } from './modules/topic-board/topic-board-data.js?v=20260909-books-v1';
import { mountCatalog } from './modules/catalog/catalog-ui.js?v=20260909-infernal-profiles-v1';
