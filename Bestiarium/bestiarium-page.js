import { BESTIARY_ENTRIES } from './modules/catalog/catalog-data.js?v=20260912-infernal-corrections-v2';
import { BESTIARY_TOPICS } from './modules/topic-board/topic-board-data.js?v=20260909-books-v1';
import { mountCatalog } from './modules/catalog/catalog-ui.js?v=20260912-infernal-corrections-v2';
import { mountTopicBoard } from './modules/topic-board/topic-board-ui.js?v=20260909-books-v1';
