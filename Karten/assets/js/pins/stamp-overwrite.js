(function(){
  ...
  function placeStamp(mapX, mapY){
    ...
    const pin = {
      ...
      kind: stampTemplate.kind || 'place',
      ...(stampTemplate.lettering ? { lettering: JSON.parse(JSON.stringify(stampTemplate.lettering)) } : {}),
      ...(stampTemplate.templateId ? { templateId: stampTemplate.templateId } : {}),
